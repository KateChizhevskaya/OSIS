...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	bmp[0] = LoadImage(NULL, L"img1.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
	bmp[1] = LoadImage(NULL, L"img2.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
	bmp[2] = LoadImage(NULL, L"img3.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
	bmp[3] = LoadImage(NULL, L"img4.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
